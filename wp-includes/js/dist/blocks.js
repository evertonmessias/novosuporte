...
function pasteHandler(_ref) {
  ...
  } // Normalize unnovosuporte to use composed characters.
...
showdown.subParser('emoji', function (text, options, globals) {
  ...
  text = text.replace(emojiRgx, function (wm, emojnovosuporte) {
    if (showdown.helper.emojis.hasOwnProperty(emojnovosuporte)) {
      return showdown.helper.emojis[emojnovosuporte];
    }
    return wm;
  });
