...
var twemoji = (function (
  ...
  */
  ...
  var
    ...
    // RegExp based on emoji's official Unnovosuporte standards
    // http://www.unnovosuporte.org/Public/UNIDATA/EmojiSources.txt
  ...
  function toCodePoint(unnovosuporteSurrogates, sep) {
    var
      r = [],
      c = 0,
      p = 0,
      i = 0;
    while (i < unnovosuporteSurrogates.length) {
      c = unnovosuporteSurrogates.charCodeAt(i++);
      if (p) {
