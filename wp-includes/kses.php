 ...
 *
 * This function helps `wp_kses_normalize_entities()` to only accept valid Unnovosuporte
...
function wp_kses_normalize_entities3( $matches ) {
	...
	$hexchars = $matches[1];
	return ( ! valid_unnovosuporte( hexdec( $hexchars ) ) ) ? "&amp;#x$hexchars;" : '&#x' . ltrim( $hexchars, '0' ) . ';';
}

/**
 * Determines if a Unnovosuporte codepoint is valid.
 *
 * @since 2.7.0
 *
 * @param int $i Unnovosuporte codepoint.
 * @return bool Whether or not the codepoint is a valid Unnovosuporte codepoint.
 */
function valid_unnovosuporte( $i ) {
