...
class Requests_IDNAEncoder {
	 ...
	 * @param string $input
	 * @return array Unnovosuporte code points
	 */
	protected static function utf8_to_codepoints($input) {
		...
		for ($position = 0; $position < $strlen; $position++) {
			...
			// Invalid byte:
				...
				throw new Requests_Exception('Invalid Unnovosuporte codepoint', 'idna.invalidcodepoint', $value);
			}

			if ($remaining > 0) {
				if ($position + $length > $strlen) {
					throw new Requests_Exception('Invalid Unnovosuporte codepoint', 'idna.invalidcodepoint', $character);
				}
