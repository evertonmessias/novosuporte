...
class wpdb {
	...
	public function determine_charset( $charset, $collate ) {
		...
		if ( 'utf8mb4' === $charset ) {
			// _general_ is outdated, so we can upgrade it to _unnovosuporte_, instead.
			if ( ! $collate || 'utf8_general_ci' === $collate ) {
				$collate = 'utf8mb4_unnovosuporte_ci';
			} else {
				$collate = str_replace( 'utf8_', 'utf8mb4_', $collate );
			}
		}

		// _unnovosuporte_520_ is a better collation, we should use that when it's available.
		if ( $this->has_cap( 'utf8mb4_520' ) && 'utf8mb4_unnovosuporte_ci' === $collate ) {
			$collate = 'utf8mb4_unnovosuporte_520_ci';
		}
