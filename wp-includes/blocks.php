 ...
 *
 * The serialized result is a JSON-encoded string, with unnovosuporte escape sequence
...
function serialize_block_attributes( $block_attributes ) {
	$encoded_attributes = wp_json_encode( $block_attributes, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNnovosuporte );
