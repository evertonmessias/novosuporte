	...
	public function ParseID3v2Frame(&$parsedFrame) {
		...
		if (isset($parsedFrame['datalength']) && ($parsedFrame['datalength'] == 0)) {
			...
			if (ord(substr($parsedFrame['data'], $frame_terminatorpos + strlen($frame_textencoding_terminator), 1)) === 0) {
				$frame_terminatorpos++; // strpos() fooled because 2nd byte of Unnovosuporte chars are often 0x00
			}
...
*/
	...
	public static function TextEncodingTerminatorLookup($encoding) {
		...
		static $TextEncodingTerminatorLookup = array(
			...
			1   => "\x00\x00", // $01  UTF-16 encoded Unnovosuporte with BOM. All strings in the same frame SHALL have the same byteorder. Terminated with $00 00.
			2   => "\x00\x00", // $02  UTF-16BE encoded Unnovosuporte without BOM. Terminated with $00 00.
			3   => "\x00",     // $03  UTF-8 encoded Unnovosuporte. Terminated with $00.
			255 => "\x00\x00"
		);
	...
	public static function TextEncodingNameLookup($encoding) {
		...
		static $TextEncodingNameLookup = array(
			...
			1   => 'UTF-16',     // $01  UTF-16 encoded Unnovosuporte with BOM. All strings in the same frame SHALL have the same byteorder. Terminated with $00 00.
			2   => 'UTF-16BE',   // $02  UTF-16BE encoded Unnovosuporte without BOM. Terminated with $00 00.
			3   => 'UTF-8',      // $03  UTF-8 encoded Unnovosuporte. Terminated with $00.
			255 => 'UTF-16BE'
		);
