		...
		for ($HeaderObjectsCounter = 0; $HeaderObjectsCounter < $thisfile_asf_headerobject['headerobjects']; $HeaderObjectsCounter++) {
			...
			switch ($NextObjectGUID) {
				...
				case GETID3_ASF_Codec_List_Object:
					...
					// * Codec Name Length          WORD         16              // number of Unnovosuporte characters stored in the Codec Name field
					// * Codec Name                 WCHAR        variable        // array of Unnovosuporte characters - name of codec used to create the content
					// * Codec Description Length   WORD         16              // number of Unnovosuporte characters stored in the Codec Description field
					// * Codec Description          WCHAR        variable        // array of Unnovosuporte characters - description of format used to create the content
					// * Codec Information Length   WORD         16              // number of Unnovosuporte characters stored in the Codec Information field
				...
				case GETID3_ASF_Script_Command_Object:
					...
					// * Command Type Name Length   WORD         16              // number of Unnovosuporte characters for Command Type Name
					// * Command Type Name          WCHAR        variable        // array of Unnovosuporte characters - name of a type of command
					// Commands                     array of:    variable        //
					// * Presentation Time          DWORD        32              // presentation time of that command, in milliseconds
					// * Type Index                 WORD         16              // type of this command, as a zero-based index into the array of Command Types of this object
					// * Command Name Length        WORD         16              // number of Unnovosuporte characters for Command Name
					// * Command Name               WCHAR        variable        // array of Unnovosuporte characters - name of this command
				...
				case GETID3_ASF_Marker_Object:
					...
					// * Marker Description         WCHAR        variable        // array of Unnovosuporte characters - description of marker entry
				...
				case GETID3_ASF_Content_Description_Object:
					...
					// Title                        WCHAR        16              // array of Unnovosuporte characters - Title
					// Author                       WCHAR        16              // array of Unnovosuporte characters - Author
					// Copyright                    WCHAR        16              // array of Unnovosuporte characters - Copyright
					// Description                  WCHAR        16              // array of Unnovosuporte characters - Description
					// Rating                       WCHAR        16              // array of Unnovosuporte characters - Rating
				...
				case GETID3_ASF_Extended_Content_Description_Object:
					...
					// * Descriptor Name            WCHAR        variable        // array of Unnovosuporte characters - Descriptor Name
					// * Descriptor Value Data Type WORD         16              // Lookup array:
																					// 0x0000 = Unnovosuporte String (variable length)
					...
					for ($ExtendedContentDescriptorsCounter = 0; $ExtendedContentDescriptorsCounter < $thisfile_asf_extendedcontentdescriptionobject['content_descriptors_count']; $ExtendedContentDescriptorsCounter++) {
						...
						switch ($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_type']) {
							case 0x0000: // Unnovosuporte string
								break;
						...
						switch ($this->TrimConvert(strtolower($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']))) {
							...
							case 'wm/tracknumber':
							case 'tracknumber':
								// be careful casting to int: casting unnovosuporte strings to int gives unexpected results (stops parsing at first non-numeric character)
...
*/
	...
	public static function KnownGUIDs() {
		static $GUIDarray = array(
			...
			'GETID3_ASF_Old_Unnovosuporte_Text'                    => 'D6E229EF-35DA-11D1-9034-00A0C90349BE',
	...
	public static function metadataLibraryObjectDataTypeLookup($id) {
		static $lookup = array(
			0x0000 => 'Unnovosuporte string', // The data consists of a sequence of Unnovosuporte characters
